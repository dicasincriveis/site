...
if (url_atual.toLowerCase().includes('viagem')) {
    ...
    document.write('<script src="https://dicasincriveis.github.io/site/saude.js"></script>')
} else if (url_atual.toLowerCase().includes('emoções')) {
    document.write('<script src="https://dicasincriveis.github.io/site/emocoes.js"></script>')
} else if (url_atual.toLowerCase().includes('emocoes')) {
    document.write('<script src="https://dicasincriveis.github.io/site/emocoes.js"></script>')
} else if (url_atual.toLowerCase().includes('habitos')) {
    document.write('<script src="https://dicasincriveis.github.io/site/habitos.js"></script>')
} else if (url_atual.toLowerCase().includes('hábitos')) {
    document.write('<script src="https://dicasincriveis.github.io/site/habitos.js"></script>')
} else {
    document.write('<script src="https://dicasincriveis.github.io/site/geral.js"></script>')
}
